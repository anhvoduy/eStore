  ...
  upload.imageDimensions = function (file) {
    ...
    $timeout(function () {
      ...
      upload.dataUrl(file).then(function (dataUrl) {
        ...
        function success() {
          //optimize to get the natural width and height of image instead of clientWidth and clientHeight (to fix issue of zooming in / out of page)
...
ngFileUpload.service('UploadResize', ['UploadValidate', '$q', '$timeout', function (UploadValidate, $q, $timeout) {
  ...
  upload.isResizeSupported = function() {
    ...
    return Base64.decode && elem.getContext && elem.getContext('2d');
  };
